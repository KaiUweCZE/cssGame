...
const SecondScene = (props) => {
    ...
    return(
        <div className="container-welcome">
            ...
            <MainEmoji intro={true} messageAction={[1,3]} step={step} text={mainEmoji.textIntro.first} cssClass='main' />
            <GuideEmoji intro={true} messageAction={[2,4]} step={step} text={guideEmoji.textIntro.first} />
        </div>
    )
}
