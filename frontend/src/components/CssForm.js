    ...
    <>
      <div className="container-form">
        ...
        <form className="form-css" onSubmit={handleSubmit}>
          {cssProperties.map((property, index) => (
            <div className="form-css__row" key={index}>
              <input
                ...
                onChange={(e) => {
                  setPropertyAtIndex(index, e.target.value),
              ...
              {index > 0 ? (
                <img
                  className="icon"
                  onClick={() => {
                    handleRemoveInput(index), handleRemoveLabel(index);
                  }}
                  src={cssFormImages.minusIcon}
                  alt=""
                />
              ) : (
                ""
          ...
          <div className="box-buttons">
            {stopAdd ? (
              ...
              <img
                className="icon"
                src={cssFormImages.plusIcon}
                alt=""
                onClick={() => {
                  handleAddInput(), handleAddLabel();
                }}
              />
            )}
            <button
              className="play"
              onMouseLeave={() => setIcon(cssFormImages.playIcon)}
              onMouseEnter={() => setIcon(cssFormImages.playIconAfter)}
              type="submit"
            >
              <img src={icon} />
            </button>
        ...
        <img
          ...
          src={cssFormImages.rightBracket}
          alt=""
        />
        {isFocused ? (
