...
const EnemyEmoji = (props) => {
  ...
  const currentLevelAnimations = data.level.find(e => e.id === props.level).animations
  ...
  return (
    <>
      ...
      : <EmojiMessage text="tenhle most nemůžu nechat bez povšimnutí" specialClass="enemy"/>
      )
      :
      ""
      }
