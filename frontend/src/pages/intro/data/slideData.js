...
export const slideData = [
  {
    id: 1,
    headline: "Ztráta",
    paragraph: `V dalekém koutě internetu, kde se rodí emoce a příběhy, byl Emoji - symbol radosti a sdílení - unesen zhrzeným kodérem, který pro samou šeď ve svém životě nechtěl zpřístupnit více barev druhým. Teď se Emoji ocitá v labyrintu CSS, kde každá vlastnot, každý blok pravidel představuje další zkoušku na cestě za svobodou.
